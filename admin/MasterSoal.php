	...
	<section class="content">
		...
		<div class="panel panel-default panel-info">
			...
			<div class="panel panel-heading panel-info">
				<span class="glyphicon glyphicon-user"></span> Master Soal
			</div>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Edit Status Soal</h4>
				</div>
				<div class="modal-body">
					<label id="test">Id</label>
					<input type="hidden" name="Id" id="Id" class="form-control test"/>
					<br />
					<label>Id Mapel</label>
					<input type="text" name="IdMapel" id="IdMapel" class="form-control" />
					<br />
					<label>status</label>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$(document).on('submit', '#user_form', function(event){
			...
			var Kelas = $('#Kelas').val();
			if(IdMapel != '' && status != '' && Kelas != '')
			{
				$.ajax({
					url:"model_soal/insert.php",
					method:'POST',
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				url:"model_soal/fetch_single.php",
				method:"POST",
