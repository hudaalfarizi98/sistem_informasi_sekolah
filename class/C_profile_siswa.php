				...
				<ul class="timeline">
					...
					<li>
						...
						<div class="timeline-item">
							<span class="time"><i class="fa fa-clock-o"></i> <?php date('Y-m-d H:i:s') ;?></span>

							<h3 class="timeline-header"><a href='readmore_siswa.php?id=<?=$value['IdPost'];?> '><?php echo $value['Judul'];?></a> ...</h3>
