        ...
        <form method="POST">
          <div id="new" class="panel panel-default panel-info">
            ...
            <div class="panel panel-body">
              ...
              <?php
              $file = $_GET['id'];
              $query = "SELECT * FROM post_materi WHERE IdPost='$file'";
              $forward->get_edit_Post($query);

              ;?>
            </div>
            <div class="panel panel-footer"> <input class="btn btn-primary" type="submit" name="update" value="update"></div>
          </div>
        </form>
      </div>
        <!-- /content -->
